...
एजेंट के माध्यम से आवेदन शुरू करने के बाद (देखें)।[संदर्भ](https://opentelemetry.io/docs/instrumentation/python/automatic/#configuring-the-agent)) और एक टेक्स्ट लॉग फ़ाइल रखें:
...
इस सेटअप के साथ हमें ओटेल कलेक्टर के अलावा भी मिलता है[जैगर यूआई](https://github.com/jaegertracing/jaeger-ui) running under <http://0.0.0.0:16686/>जो कॉल को विज़ुअलाइज़ करने में मदद करेगा। वैकल्पिक यूआई जो समर्थित हैं वे हैं`Prometheus`और`ZipKin`.
...
Let’s filter in Jaeger UI (<http://0.0.0.0:16686/>) टैग का उपयोग करने वाले यूआरएल में से एक के लिए`== url goes here ==`.
