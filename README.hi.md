...
इस सेटअप के साथ हमें ओपन टेलीमेट्री कलेक्टर के अलावा भी मिलता है[जैगर यूआई](https://github.com/jaegertracing/jaeger-ui)के अंतर्गत चल रहा है<http://0.0.0.0:16686/>जो कॉल को विज़ुअलाइज़ करने में मदद करेगा। वैकल्पिक यूआई जो समर्थित हैं वे हैं`Prometheus`और`ZipKin`.

क्लाइंट और सर्वर सीधे ओटेल कलेक्टर को डेटा भेजते हैं; ओटेल कलेक्टर इस डेमो जैगर में डेटा को उचित बैकएंड पर भेजता है।
